...
# базовая лосс-функция
base_loss = tf.keras.losses.BinaryCrossentropy(from_logits = True, label_smoothing=0.15)

# В эту функцию заходят отклики с дискриминатора после истиных и сгенерированных изображений
...
# в эту функцию заходят отклики с генератора
