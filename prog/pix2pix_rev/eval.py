...
from skimage.color import gray2rgb, rgb2gray # для преобразования исходных данных изображений
...
g_last_weights = './d_last_weights.h5'
...
plt.imshow(pr_img,cmap='gray') # выводим на экран
plt.show()
# загружаем контрольное изображение
out_img_file = './test/1_out.jpg'
