...
OUT_FOLDER = './dataset' # куда будут сохранены таблицы файлов для обучения и валидации модели
INPUT_IMG_FOLDER = './dataset/skeletons' # входные изображения
OUTPUT_IMG_FOLDER = './dataset/animal' # выходные изображения
...
# генерация обучающих и валидационных таблиц
train_t = []
for input_img_file in input_img_files:
    inp = input_img_file
    # нахождение выходного аналога файла без учета разрешения
    out = None
